...
- Does loading `R_packages/4.3.1` load the `R` module? 
...
## sens2017625, SSH, interactive session

```text
[richel@sens2017625-b4 ~]$ time module load R_packages/4.3.1
...
****************************************************************************
###################d####q####w############x#####x################x##############x###
ssh: connect to host sens2016001-bianca.uppmax.uu.se port 22: No route to host
Connection to bianca.uppmax.uu.se closed.
richel@richel-N141CU:~$ ssh richel-sens2016001@bianca.uppmax.uu.se
richel-sens2016001@bianca.uppmax.uu.se's password: 
Last login: Fri Dec  6 07:23:44 2024 from vpnpool189-175.anst.uu.se
############################################################################
# Login node NOT up! Boot initiated. Just wait for prompt                  #
# or login again later. This can take from 2 to 6 minutes                  #
############################################################################
...
richel@richel-N141CU:~$ ssh richel-sens2016001@bianca.uppmax.uu.se
richel-sens2016001@bianca.uppmax.uu.se's password: 
Last login: Fri Dec  6 07:33:03 2024 from vpnpool189-175.anst.uu.se
############################################################################
# Login node NOT up! Boot initiated. Just wait for prompt                  #
# or login again later. This can take from 2 to 6 minutes                  #
############################################################################
...
richel@richel-N141CU:~$ ssh richel-sens2016001@bianca.uppmax.uu.se
richel-sens2016001@bianca.uppmax.uu.se's password: 
Last login: Fri Dec  6 07:45:32 2024 from vpnpool189-175.anst.uu.se
############################################################################
# Login node NOT up! Boot initiated. Just wait for prompt                  #
# or login again later. This can take from 2 to 6 minutes                  #
############################################################################
...
richel@richel-N141CU:~$ ssh richel-sens2016001@bianca.uppmax.uu.se
richel-sens2016001@bianca.uppmax.uu.se's password: 
Last login: Fri Dec  6 07:52:05 2024 from vpnpool189-175.anst.uu.se
############################################################################
# Login node NOT up! Boot initiated. Just wait for prompt                  #
# or login again later. This can take from 2 to 6 minutes                  #
############################################################################
...
richel@richel-N141CU:~$ ssh richel-sens2016001@bianca.uppmax.uu.se
richel-sens2016001@bianca.uppmax.uu.se's password: 
Last login: Fri Dec  6 08:08:11 2024 from vpnpool189-175.anst.uu.se
############################################################################
# Login node NOT up! Boot initiated. Just wait for prompt                  #
# or login again later. This can take from 2 to 6 minutes                  #
############################################################################
...
richel@richel-N141CU:~$ ssh richel-sens2016001@bianca.uppmax.uu.se
richel-sens2016001@bianca.uppmax.uu.se's password: 
Last login: Fri Dec  6 08:18:57 2024 from vpnpool189-175.anst.uu.se
############################################################################
# Login node NOT up! Boot initiated. Just wait for prompt                  #
# or login again later. This can take from 2 to 6 minutes                  #
############################################################################
...
richel@richel-N141CU:~$ ssh richel-sens2016001@bianca.uppmax.uu.se
richel-sens2016001@bianca.uppmax.uu.se's password: 
Last login: Fri Dec  6 08:28:20 2024 from vpnpool189-175.anst.uu.se
############################################################################
# Login node NOT up! Boot initiated. Just wait for prompt                  #
# or login again later. This can take from 2 to 6 minutes                  #
############################################################################
...
richel@richel-N141CU:~$ ssh richel-sens2016001@bianca.uppmax.uu.se
richel-sens2016001@bianca.uppmax.uu.se's password: 
Last login: Fri Dec  6 08:39:34 2024 from vpnpool189-175.anst.uu.se
############################################################################
# Login node NOT up! Boot initiated. Just wait for prompt                  #
# or login again later. This can take from 2 to 6 minutes                  #
############################################################################
